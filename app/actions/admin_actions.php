...
if ($action === 'verify_approve') {
    ...
    header('Location: ../pages/admin_panel.php?tab=verificaciones&msg=aprobado');
    exit;
}
...
if ($action === 'verify_reject') {
    ...
    header('Location: ../pages/admin_panel.php?tab=verificaciones&msg=rechazado');
    exit;
}
...
if ($action === 'toggle_destacado') {
    ...
    header('Location: ../pages/admin_panel.php?tab=servicios');
    exit;
}
...
if ($action === 'delete_service') {
    ...
    header('Location: ../pages/admin_panel.php?tab=servicios&msg=deleted');
    exit;
}
...
if ($action === 'delete_user') {
    ...
    if ($id !== $mi_id && $id > 0) {
        ...
        if ($contratos_activos > 0 && !isset($_POST['confirmar_forzar'])) {
            header("Location: ../pages/admin_panel.php?tab=usuarios&warn=contratos_activos&uid=$id&n=$contratos_activos");
            exit;
        }
    ...
    header('Location: ../pages/admin_panel.php?tab=usuarios&msg=user_deleted');
    exit;
}
...
if ($action === 'add_categoria') {
    ...
    header('Location: ../pages/admin_panel.php?tab=categorias&msg=cat_added');
    exit;
}
...
if ($action === 'suspender_usuario') {
    ...
    header('Location: ../pages/admin_panel.php?tab=usuarios&msg=suspendido');
    exit;
}
...
if ($action === 'reactivar_usuario') {
    ...
    header('Location: ../pages/admin_panel.php?tab=usuarios&msg=reactivado');
    exit;
}
