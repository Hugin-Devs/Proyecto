...
<head>
    ...
    <script src="../../public/libs/jspdf.plugin.autotable.min.js"></script>
</head>
<body>
...
<div class="main-content">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($v['estado'] == 'pendiente'): ?>
                                <form action="../actions/admin_actions.php" method="POST" style="display:inline;">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="../actions/admin_actions.php" method="POST" onsubmit="return confirm('¿Seguro que deseas eliminar este servicio?');">
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex; gap:6px;">
                                ...
                                <?php if ($u['suspendido_at'] === null): ?>
                                    <form action="../actions/admin_actions.php" method="POST" style="display:inline;" onsubmit="return confirm('¿Seguro que deseas suspender a este usuario? Perderá acceso temporalmente.');">
                                ...
                                <form action="../actions/admin_actions.php" method="POST" style="display:inline;" onsubmit="return confirm('¿Eliminar usuario? Perderá acceso y sus servicios serán ocultados.');">
                                    <input type="hidden" name="action" value="delete_user">
                                    <input type="hidden" name="id" value="<?= $u['id'] ?>">
    ...
    <div id="tab-categorias" class="tab-content <?= $tab == 'categorias' ? 'active' : '' ?>">
        ...
        <div style="background: var(--card-bg); padding: 24px; border-radius: var(--radius); border: 1px solid var(--border); margin-bottom: 24px; max-width: 500px;">
            ...
            <form action="../actions/admin_actions.php" method="POST" class="form-group">
...
function cargarAuditLogs(page) {
    ...
    fetch(`../actions/admin_actions.php?action=get_audit_log&tipo=${tipo}&uid=${uid}&desde=${desde}&hasta=${hasta}&p=${page}`)
        .then(r => r.json())
        .then(res => {
...
function cargarChatThreads() {
    ...
    fetch('../actions/admin_actions.php?action=get_chat_hilos')
        .then(r => r.json())
        .then(res => {
...
function verChatDetalle(servicio_id, cliente_id, titulo, cliente_nombre, proveedor_nombre) {
    ...
    fetch(`../actions/admin_actions.php?action=get_chat_mensajes_hilo&servicio_id=${servicio_id}&cliente_id=${cliente_id}`)
        .then(r => r.json())
        .then(res => {
...
function buscarPerfilLive() {
    ...
    fetch(`../actions/admin_actions.php?action=search_users&q=${encodeURIComponent(query)}`)
        .then(r => r.json())
        .then(res => {
...
function verPerfilUsuario(uid) {
    ...
    fetch(`../actions/admin_actions.php?action=get_user_profile&uid=${uid}`)
        .then(r => r.json())
        .then(res => {
            if (!res.ok) {
                emptyView.style.display = 'block';
